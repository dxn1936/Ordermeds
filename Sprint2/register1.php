            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-9" id="content">            <div class="breadcrumbs">
                        ...
                        <form id="register_form" method="post" autocomplete="off" action="newReg.php">
									...
									<div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="username" placeholder="Username" value="" name="username"
											 tabindex="2" title="Username must not be blank and contain only letters, numbers and underscores."  required pattern="\w+">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
											...
											maxlength="10" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
